...
export const reconcileVersion = new RegExp(
  `${lrsServer.source}/reconcileVersion\\b`
);
...
export const geometryToMeasure = new RegExp(
  `${networkLayer.source}/geometryToMeasure\\b`
);
export const measureToGeometry = new RegExp(
  `${networkLayer.source}/measureToGeometry\\b`
);
export const translate = new RegExp(`${networkLayer.source}/translate\\b`);
export const concurrencies = new RegExp(
  `${networkLayer.source}/concurrencies\\b`
);
export const queryAttributeSet = new RegExp(
  `${networkLayer.source}/queryAttributeSet\\b`
);
...
export const geometryToStation = new RegExp(
  `${eventLayer.source}/geometryToStation\\b`
);
export const stationToGeometry = new RegExp(
  `${eventLayer.source}/stationToGeometry\\b`
);
...
export const centerlineLayers = new RegExp(
  `${lrsServer.source}/centerlineLayers\\b`
);
export const centerlineLayer = new RegExp(`${centerlineLayers.source}/\\d+\\b`);

export const calibrationPointLayers = new RegExp(
  `${lrsServer.source}/calibrationPointLayers\\b`
);
export const calibrationPointLayer = new RegExp(
  `${calibrationPointLayers.source}/\\d+\\b`
);

export const intersectionLayers = new RegExp(
  `${lrsServer.source}/intersectionLayers\\b`
);
export const intersectionLayer = new RegExp(
  `${intersectionLayers.source}/\\d+\\b`
);
